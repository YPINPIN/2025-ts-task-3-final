...
import { apiClientGetAllProducts, apiClientGetProducts } from '@/api/products'
...
const getAllProducts = async () => {
  try {
    const res = await apiClientGetAllProducts()
                ...
                <ul class="list-unstyled">
                  <li>
                    <button
                      ...
                      class="d-block py-2 border-0 bg-transparent"
                      :class="selectedCategory === '' ? 'text-success' : 'text-muted'"
                      type="button"
                    >
                      全部
                    </button>
                  ...
                  <li v-for="category in categories" :key="category">
                    <button
                      ...
                      class="d-block py-2 border-0 bg-transparent"
                      :class="selectedCategory === category ? 'text-success' : 'text-muted'"
                      type="button"
                    >
                      {{ category }}
                    </button>
